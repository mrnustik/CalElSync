...
builder.Services.AddTransient<
    ...
    JsonCalendarProjectMappingProvider
>();
builder
    .Services.AddOptions<JsonCalendarMappingOptions>()
    .Bind(builder.Configuration.GetSection("CalendarsFile"))
    .ValidateDataAnnotations()
    .ValidateOnStart();
builder
    .Services.AddOptions<SyncScheduleOptions>()
...
app.MapPost(
    "/sync",
    async (ISynchronizeCalendarEventsToTasks sync, CancellationToken ct) =>
    {
